...
export function Phase2ConsultationFlow() {
  const [currentStep, setCurrentStep] = useState(1);
  const [showCollaboration, setShowCollaboration] = useState(false);
  const [consultationData, setConsultationData] = useState(() => {
    const saved = localStorage.getItem('consultation-draft-phase2');
  ...
  const handleSave = () => {
    localStorage.setItem('consultation-draft-phase2', JSON.stringify(consultationData));
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-h3 text-neutral-900">Phase 2: Intelligence & Communication</h2>
